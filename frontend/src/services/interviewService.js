...
export const interviewService = {
  ...
  // AI calls - use aiApi (180s timeout)
  ...
  // Questions use aiApi (180s timeout)
  ...
  // ── Reports ──────────────────────────────────────────────
  getReport:           (sid)  => api.get(`/report/session/${sid}`),
  generateReport:      (sid)  => aiApi.post(`/report/session/${sid}/generate`),
  getInterviewRanking: (iid)  => api.get(`/report/interview/${iid}/ranking`),
